...
declare const RentmonitorServerApplication_base: (new (...args: any[]) => {
    [x: string]: any;
    projectRoot: string;
...
export declare class RentmonitorServerApplication extends RentmonitorServerApplication_base {
